...
penext :: { Pexpr -> Located Pexpr }
    ...
    | XOR pexpr   { \e -> mk_loc (loc $1) (Peop2 Pxor e (unloc $2)) }
...
pformula :: { Located Pformula }
    : EXISTS pquantifieriden pformula { mk_loc (loc $1) $ Pfexists (unloc $2) (unloc $3) }
    | FORALL pquantifieriden pformula { mk_loc (loc $1) $ Pfforall (unloc $2) (unloc $3) }
    | pexpr { lmap Pfltl $1 }

pquantifieriden :: { Located String }
    : ident DOT { $1 }
    | ident { fmap init $1 }
...
parsePident :: String -> Maybe Pident
parsePident str = case runIdentParser "" (fromString str) of
    Left err -> Nothing
    Right (Located _ n) -> Just n
    
parseExpr :: String -> Maybe Pexpr
parseExpr str = case runExprParser "" (fromString str) of
    Left err -> Nothing
    Right (Located _ n) -> Just n

...
instance NFData Pformula

data Pmodule = Pmodule { p_name :: String, p_items :: [Located Pitem] }
    deriving (Eq,Ord,Show,Generic)

instance NFData Pmodule

data Pident = Pident String Pdims deriving (Eq,Ord,Show,Generic)

instance NFData Pident
...
instance NFData Ptype

data Pvar = Pvar { pvar_name :: Pident, pvar_type :: Ptype }
    deriving (Eq,Ord,Show,Generic)

instance NFData Pvar

data Pdefine = Pdefine { pdef_lhs :: String, pdef_rhs :: Pexpr }
    deriving (Eq,Ord,Show,Generic)

instance NFData Pdefine

data Popn = Pand | Por | Pset deriving (Eq,Ord,Show,Generic)

instance NFData Popn

data Pop1 = Pnot | Pf | Pg | Px | Py | Pz | Ph | Pnext | Pcast ExprType {-injected in translation-} deriving (Eq,Ord,Show,Generic)

instance NFData Pop1

data Pop2 = Pin | Pequiv | Pimplies | Pplus | Pminus | Ptimes | Pmod | Pxor | Punion | Peq | Pneq | Plt | Pleq | Pgt | Pgeq | Pu | Pv deriving (Eq,Ord,Show,Generic)

instance NFData Pop2
...
isFiniteLTLOp1 :: Pop1 -> Bool
isFiniteLTLOp1 Pf = False
isFiniteLTLOp1 Pg = False
isFiniteLTLOp1 Px = True
isFiniteLTLOp1 Py = False
isFiniteLTLOp1 Pz = False
isFiniteLTLOp1 Ph = False
isFiniteLTLOp1 _ = True

isFiniteLTLOp2 :: Pop2 -> Bool
isFiniteLTLOp2 Pu = False
isFiniteLTLOp2 Pv = False
isFiniteLTLOp2 _ = True

isInfiniteLTLOp1 :: Pop1 -> Bool
isInfiniteLTLOp1 o = isLTLOp1 o && not (isFiniteLTLOp1 o)

isInfiniteLTLOp2 :: Pop2 -> Bool
isInfiniteLTLOp2 o = isLTLOp2 o && not (isFiniteLTLOp2 o)
...
ptimes :: Pexpr -> Pexpr -> Pexpr
ptimes (Peint i) (Peint j) = Peint (i*j)
ptimes e1 e2 = Peop2 Ptimes e1 e2
...
pcast :: ExprType -> Pexpr -> Pexpr
pcast t e = Peop1 (Pcast t) e

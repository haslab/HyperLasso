...
module Data.SBV.Control.Utils (
     ...
     , inNewContext, freshVar, freshVar_, svFreshVar
...
svFreshVar :: forall m. (MonadIO m, MonadQuery m) => Kind -> String -> m SVal
svFreshVar k nm = inNewContext $ svMkSymVar QueryVar k (Just nm)
